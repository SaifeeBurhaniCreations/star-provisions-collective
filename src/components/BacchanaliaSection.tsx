    ...
    <section id="bacchanalia" className="py-24 bg-background">
      ...
      <div className="bg-charcoal py-20 mb-20">
        <div className="container mx-auto px-6">
          ...
          >
            <span className="text-gold text-sm tracking-[0.4em] uppercase block mb-4">
              Fine Dining
            </span>
            <h2 className="font-serif text-5xl md:text-6xl text-primary-foreground mb-6">
              Bacchanalia
            </h2>
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-24">
          ...
          >
            <span className="text-gold text-sm tracking-[0.3em] uppercase mb-4">
              The Experience
            </span>
          ...
          >
            ...
            />
            <div className="absolute -bottom-6 -left-6 bg-primary p-6 shadow-elegant">
        ...
        >
          <div className="text-center mb-12">
            <span className="text-gold text-sm tracking-[0.3em] uppercase block mb-4">
              Current Menu
            </span>
            ...
            {Object.entries(menuCourses).map(([course, items]) => (
              <TabsContent key={course} value={course} className="mt-0">
                <div className="grid md:grid-cols-2 gap-6">
                  {items.map((item, idx) => (
                    <div key={idx} className="group p-4 hover:bg-muted/50 transition-colors">
