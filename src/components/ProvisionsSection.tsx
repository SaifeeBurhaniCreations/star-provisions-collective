    ...
    <section id="provisions" className="py-24 bg-cream">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center mt-8 text-sm text-muted-foreground">
        ...
        >
          {marketCategories.map((category, idx) => (
            <div key={idx} className="group relative overflow-hidden bg-background shadow-soft">
        ...
        >
          <div className="text-center mb-12">
            <span className="text-forest text-sm tracking-[0.3em] uppercase block mb-4">
              Cafe Menu
            </span>
            ...
            <TabsContent value="breakfast" className="mt-0">
              <div className="space-y-4">
                {breakfastMenu.map((item, idx) => (
                  <div key={idx} className="flex justify-between items-start py-3 border-b border-border">
                    <div>
